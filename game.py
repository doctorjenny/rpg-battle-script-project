...
class Person:
    ...
    def get_enemy_stats(self):
        ...
        hp_string = str(self.hp) + "/" + self.maxhp
    ...
    def get_stats(self):
        ...
        print(bcolors.BOLD + self.name + "      " +
              str(current_hp) + " |" + bcolors.OKGREEN + hp_bar + bcolors.ENDC + bcolors.BOLD +
              "|      " + str(current_mp) + " |" + bcolors.OKBLUE + mp_bar + bcolors.ENDC + bcolors.BOLD + "|")
        print("\n\n")
